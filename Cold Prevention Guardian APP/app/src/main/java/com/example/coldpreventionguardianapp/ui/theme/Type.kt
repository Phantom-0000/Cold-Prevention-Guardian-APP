...
/**
 * Creates a Typography that scales all font sizes by [scaleFactor].
 * Used for accessibility — seniors get a 1.2x scale to match the web app's 1.2rem logic.
 */
fun createScaledTypography(scaleFactor: Float = 1.0f): Typography {
    return Typography(
